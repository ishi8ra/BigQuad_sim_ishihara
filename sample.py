...
file_names = {
    'K': 'csv_exported/K_' + current_time + '.csv',
    'P': 'csv_exported/P_' + current_time + '.csv',
    'V': 'csv_exported/V_' + current_time + '.csv',
    'acc': 'csv_exported/acc_' + current_time + '.csv',
    'Euler': 'csv_exported/Euler_' + current_time + '.csv',
    'W': 'csv_exported/W_' + current_time + '.csv',
    'Euler_rate': 'csv_exported/Euler_rate_' + current_time + '.csv',
    'input': 'csv_exported/input_' + current_time + '.csv',
}
